...
ALTER TABLE SCORE ADD CONSTRAINT SCORE_code_FK foreign key(code) REFERENCES DEPARTMENT(dept_code);
alter table SCORE modify NAME VARCHAR2(10);

INSERT INTO SCORE(NO, NAME, KOR, ENG, MATH, CODE) VALUES(111, 'Steven', 70, 80, 90, 1111);
INSERT INTO SCORE(NO, NAME, KOR, ENG, MATH, CODE) VALUES(222, 'Neena', 80, 76, 83, 2222);
INSERT INTO SCORE(NO, NAME, KOR, ENG, MATH, CODE) VALUES(333, 'Lex', 92, 77, 81, 2222);
UPDATE SCORE SET SUM = KOR + ENG + MATH;
UPDATE SCORE SET AVERAGE = SUM / 3;
SELECT * FROM SCORE;
SELECT ROUND(AVERAGE,1) FROM SCORE;
SELECT NO, NAME, KOR, ENG, MATH, SUM, ROUND(AVERAGE,1),CODE FROM SCORE;
